...
def extract_lbp(image, number_points, radius, eps=1e-7):
...
for train_name in train_names:
        ...
        for file in glob.glob(cur_path ):
                if (file!="dataset/train/desktop.ini"):  # o  googledrive armazena um arquivo desktop.ini na pasta....
                        ...
                        gray=lerimagem(file)
                        features=extract_lbp(gray, number_points=24, radius=8)
...
classificador=svm.SVC(kernel='rbf', max_iter=-1)
